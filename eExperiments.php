...
<?php
		...
		switch ($action){
			...
			case "add":
				...
				echo "\t\t\t\t\t\t\t<option value='Black/African American'>Black/African American</option>";
				echo "\t\t\t\t\t\t\t<option value='White/Caucasian'>White/Caucasian</option>";
				echo "\t\t\t\t\t\t\t<option value='American Indian/Alaska Native'>American Indian/Alaska Native</option>";
				echo "\t\t\t\t\t\t\t<option value='Native Hawaiian/Pacific Islander'>Native Hawaiian/Pacific Islander</option>";
				echo "\t\t\t\t\t\t\t<option value='Hispanic/Latino'>Hispanic/Latino</option>";
